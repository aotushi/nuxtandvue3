  ...
  await prisma.course.create({
    data: {
      ...
      Catalogue: {
        createMany: {
          data: [
            { title: "01开篇：课程介绍和安排", source: "" },
            { title: "02上层框架最佳选择", source: "" },
            { title: "03五种渲染模式", source: "" },
            { title: "04快速创建首个nuxt项目", source: "" },
            { title: "05文件路由和布局", source: "" },
            { title: "06使用静态资源", source: "" },
            { title: "07自动导入特性", source: "" },
            { title: "08API路由", source: "" },
            { title: "09数据获取", source: "" },
            { title: "10状态管理", source: "" },
            { title: "11错误处理", source: "" },
            { title: "12常用配置和优化", source: "" },
          ],
        },
      },
    },
